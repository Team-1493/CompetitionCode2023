...
public class CustomPPS extends CommandBase {
  ...
  public static void setLoggingCallbacks(
      ...
      BiConsumer<Translation2d, Rotation2d> logError) {
        CustomPPS.logActiveTrajectory = logActiveTrajectory;
        CustomPPS.logTargetPose = logTargetPose;
        CustomPPS.logSetpoint = logSetpoint;
        CustomPPS.logError = logError;
  }
}
